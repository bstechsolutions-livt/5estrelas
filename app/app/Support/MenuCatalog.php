...
class MenuCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['key' => 'borderos_auto', 'label' => 'Borderô Automático', 'icon' => 'pi pi-bolt', 'href' => '/financeiro/borderos/automatico', 'permission' => 'financeiro.borderos.automatico_gerenciar', 'group' => 'Financeiro'],
