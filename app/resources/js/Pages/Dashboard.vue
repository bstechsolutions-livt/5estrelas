...
const feedScale = ref(1) // multiplicador da largura
...
function updateShift() {
    ...
    // Cresce levemente quando totalmente centralizado
...
onMounted(() => {
    // Acha o container que realmente rola (o <main> do AppLayout)
...
<template>
    <AppLayout>
        <div class="max-w-7xl mx-auto space-y-5">
            ...
            <!-- Two columns: stories + shortcuts (left) | news (right) -->
