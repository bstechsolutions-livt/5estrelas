...
async function carregarContrato() {
  ...
  try {
    ...
    form.value = {
      ...
      nome_cliente: contrato.nome_locador || "",
      cnpj_cliente:
...
async function salvar() {
  ...
  try {
    ...
    const dados = {
      ...form.value,
      nome_locador: form.value.nome_cliente,
      documento_locador: form.value.cnpj_cliente?.replace(/\D/g, "") || "",
      data_inicio: formatDateForApi(form.value.data_inicio),
      data_fim: formatDateForApi(form.value.data_fim)
    }
    delete dados.nome_cliente
    delete dados.cnpj_cliente
