...
<template>
    <article class="border border-gray-100 rounded-lg overflow-hidden bg-gray-50" dusk="payable-doc-preview-card">
        ...
        <button type="button" class="block w-full text-left" @click="emit('open', doc)">
            <img v-if="isImage(doc)" :src="doc.url" :alt="doc.name" class="w-full max-h-52 object-contain bg-white" />
