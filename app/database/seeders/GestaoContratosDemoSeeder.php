...
class GestaoContratosDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->seedServicosPrestados($branches);
    }

    private function seedServicosPrestados(array $branches): void
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            ...
            BsGestaoContrato::create([
                ...
                'nome_locador' => $clientes[array_rand($clientes)], // cliente (contraparte)
                'documento_locador' => $this->fakeCnpj(),
                'data_inicio' => $inicio->toDateString(),
                'data_fim' => $fim->toDateString(),
                'dia_vencimento' => random_int(1, 28),
