...
class PermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['key' => 'financeiro.contas_pagar.classificacao_gerenciar', 'label' => 'Gerenciar classificação por departamento (CP)', 'module' => 'financeiro'],
            ['key' => 'financeiro.contas_pagar.ver_todos_departamentos', 'label' => 'Ver e filtrar títulos de todos os departamentos (CP)', 'module' => 'financeiro'],
            ['key' => 'financeiro.contas_pagar.ver_todas_filiais', 'label' => 'Ver títulos de todas as filiais (CP)', 'module' => 'financeiro'],
            ...
            ['key' => 'financeiro.contas_receber.visualizar', 'label' => 'Ver contas a receber', 'module' => 'financeiro'],
            ['key' => 'financeiro.contas_receber.ver_todas_filiais', 'label' => 'Ver títulos a receber de todas as filiais (CR)', 'module' => 'financeiro'],
            ['key' => 'financeiro.plano_contas.visualizar', 'label' => 'Ver plano de contas', 'module' => 'financeiro'],
