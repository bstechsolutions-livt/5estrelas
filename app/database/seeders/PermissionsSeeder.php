...
class PermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['key' => 'financeiro.contas_pagar.ver_todos_departamentos', 'label' => 'Ver e filtrar títulos de todos os departamentos (CP)', 'module' => 'financeiro', 'description' => 'Ignorar restrição de departamento na listagem de CP.'],
